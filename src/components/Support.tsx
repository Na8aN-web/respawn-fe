        ...
        <section className="text-white relative overflow-hidden">
            ...
            <div className="flex flex-col gap-[1rem] items-center absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 w-[100%]">
                ...
                <div className="sm:text-xs text-[0.5rem] flex gap-[1rem]">
                    <span className="flex gap-1 items-center"><IoMdCheckmarkCircleOutline /> Instant service provided</span>
                    <span className="flex gap-1 items-center"><IoMdCheckmarkCircleOutline /> Real 24/7 Technical Support</span>
                </div>
