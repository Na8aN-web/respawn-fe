        ...
        <div className="w-full lg:w-1/2 bg-[#1F2937] flex items-center justify-start p-8 md:p-20">
          <div className="w-full max-w-md mx-auto">
            <div className="text-center">
              <h1 className="text-[40px] font-semibold text-white mb-2">Welcome Back</h1>
              <p className="text-[#EDE4FC] text-[16px]">Login to continue your gaming journey</p>
              <p className='text-[#A0A0A0] my-8'>
                Don't have an account? 
                <a 
                  className='text-[#7C3AED] cursor-pointer ml-1 hover:text-purple-400'
              ...
              <div className="space-y-4">
                <div className='py-1'>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-[#263549] text-white border border-gray-700 focus:border-purple-500 focus:ring-purple-500 focus:outline-none"
                  />
                </div>
                ...
                <div className="flex items-center justify-between py-4">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="remember" className="ml-2 block text-sm text-[#A0A0A0]">
                      Remember me
                    </label>
                  </div>
                  <div>
                    <a href="#" className="text-sm text-[#7C3AED] hover:text-purple-400">
                      Forgot password?
                    </a>
                  </div>
                </div>
