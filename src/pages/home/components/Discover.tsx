const Discover = () => {
    return ( 
        <section className="flex flex-col text-white text-center gap-[5rem] px-[20px] my-12 md:px-[80px] items-center">
            <div className="flex flex-col items-center gap-[1rem]">
                <h1 className="font-semibold sm:text-[32px] text-xl">Discover Skilled Players like You</h1>
                <p className="sm:text-[16px] my-4 text-[12px] md:w-full w-[60%]">
