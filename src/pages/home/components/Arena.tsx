    ...
    return ( 
        <section className="bg-gradient-to-bl from-[#D0BFED] via-[#EBE3FA] to-[#7C3AED] flex md:flex-row flex-col-reverse gap-[2rem] justify-between items-center px-[20px] md:px-[80px] pt-[3rem]">
            ...
            <div className="flex flex-col gap-[2rem]">
                ...
                <p className="sm:text-[16px] text-[0.5rem] text-[#1F2937]">
                ...
                <button className="bg-[#7C3AED] py-[0.5rem] px-[1.2rem] w-fit rounded text-white md:text-[16px] text-[0.5rem]">Get the app</button>
            </div>
        </section>
     );
}
